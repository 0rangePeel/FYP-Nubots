function [] = custom_plot(HT,CoM,Cp)
...
%% Plot Cp
    plot3(0,Cp,0.8,'*','color','red'); 

    plot3([0 0],[Cp-0.02 Cp+0.02],[0.8 0.8],'color','red')
...
%% Graphing Setup   
    ...
    ylabel('X-Axis');
    zlabel('Z-Axis');
    % title('Sagittal (Right side) View of 2D FKM')
    % title('Orthogonal View of 2D FKM with CoM')
    title('Sagittal (Right side) View of 2D Quasistatic Walking')
