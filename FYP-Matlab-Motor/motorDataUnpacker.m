function [time,current,velocity,Vin,torqueInterp] = motorDataUnpacker(motorData)
    ...
    torqueInterp = torque;
    torqueInterp(nan_indices) = interp1(non_nan_indices, torque(non_nan_indices), find(nan_indices), 'linear');
