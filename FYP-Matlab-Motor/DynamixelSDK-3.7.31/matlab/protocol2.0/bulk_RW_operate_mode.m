...
elseif dxl_error ~= 0
    ...
    fprintf('Dynamixel : Operating Mode set to Position \n');
end
...
while 1
    ...
    dxl_addparam_result = groupBulkWriteAddParam(groupwrite_num, DXL_ID, ADDR_GOAL_POSITION, LEN_GOAL_POSITION, typecast(int32(dxl_goal_position(index)), 'uint32'), LEN_GOAL_POSITION);
    if dxl_addparam_result ~= true
