...
toc
totalTime = toc;
SysIDData.timeDynamixel = linspace(0,totalTime,length(dxl_goal_pwm));
for i=1:N
...
%% Plots 2
% offset = 1.6337;
offset = mean(SysIDData.voltage1(1:500));
...
fig4 = figure();
plot(SysIDData.timeSTM, 0.3577*(SysIDData.voltage1 - offset), '-')
xlabel('Time (s)')
ylabel('Torque (Nm)')

%% Save Structure
save('SYS_ID_DATA_LOAD6.mat', 'SysIDData');
