function [] = kinematics_plot(HT,CoM,CoM_star,xe_star,CoM_star_traj)
%% Plot Forward Kinemtaics
    ...
    % 
    % plot3(r01(3),r01(1),r01(2),'*');
    % plot3(r12(3),r12(1),r12(2),'*');
    % plot3(r23(3),r23(1),r23(2),'*');
    % plot3(r34(3),r34(1),r34(2),'*');
    % plot3(r45(3),r45(1),r45(2),'*');
    % plot3(r56(3),r56(1),r56(2),'*');
    % plot3(r6RB(3),r6RB(1),r6RB(2),'*');
    % 
    % plot3(r07(3),r07(1),r07(2),'*');
    % plot3(r78(3),r78(1),r78(2),'*');
    % plot3(r89(3),r89(1),r89(2),'*');
    % plot3(r910(3),r910(1),r910(2),'*');
    % plot3(r1011(3),r1011(1),r1011(2),'*');
    % plot3(r1112(3),r1112(1),r1112(2),'*');
    % plot3(r12LB(3),r12LB(1),r12LB(2),'*');
    % 
    % OutputCoM = CoM.Output(1:3,4);
    % plot3(OutputCoM(3),OutputCoM(1),OutputCoM(2),'*');
    % 
    % 
    % %% Plot CoM_star
    ...
    %           -0.02,        1.0]);   % Y
        ...
        % title('Orthogonal View of 3D FKM')
        title('Sagittal (Right side) View of 3D FKM')
