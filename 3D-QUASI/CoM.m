...
if model.base == 1
    ...
    CoM.Ab6RB = HT.Ab6*HTf(0,-param.S/2,0);
    ...
    CoM.Ab12LB = HT.Ab12*Rx(q(12))*HTf(0,-param.S/2,0);
...
elseif model.base == -1    
    ...
    CoM.Ab6RB = HT.Ab6*Rx(-q(6))*HTf(0,-param.S/2,0);
    ...
    CoM.Ab12LB = HT.Ab12*HTf(0,-param.S/2,0);
